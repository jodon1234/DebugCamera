...
<body>
    <div class="container">
        ...
        <form method="post">
            ...
            <button class="btn" type="submit" name="action" value="test">Test Connection</button><br><br>
...
def setup_web():
    global setup_req, PLC_IP, SUBNET, GATEWAY, pre_time, cam_name, tag_tracking_text, fps, Camera_Status
